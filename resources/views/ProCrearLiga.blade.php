            ...
            <div class="container">
                ...
                <form action="" name="FormaProCrearLiga" method="post" class="form-horizontal" role="form">
                    ...
                    <div style="position:relative; left:500px;" class="container">
                        ...
                        <button type="submit" onclick="if(document.getElementById('name').value==''){alert('Ingresa la Información requerida');return false;}else{};" class="btn btn-primary">Enviar</button>
                    </div>
