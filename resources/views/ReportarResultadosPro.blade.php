...
@section('content')
    ...
    <div id="menuCentral" style="background:url(/images/middleMenu.jpeg); background-size: cover;">
        ...
        <div style="background-color: gray;" class="col-lg-9">
            <span>{{$EquipoLocal->name}}</span>
        </div>
        <div style="background-color: #0000C2;" class="co-lg-9">
            <div id="TablaPrimeraClubesPro2">
        ...
        <div style="background-color: gray;" class="col-lg-9">
            <span><a>{{$EquipoVisitante->name}}</a></span>
        </div>
        <div id="TablaPrimeraClubesPro2" class="col-lg-9" style="">
            <table>
                <thead>
                <tr>
                    <th>Número</th>
