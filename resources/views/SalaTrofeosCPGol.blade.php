        ...
        function selTrofeo(trofeo, idTrofeo)
        {
            ...
            switch (trofeo) {
                case "1ra":
                    ...
                    imagen.src="/images/trofeoG.png";
                    break;
                case "2da":
                    imagen.src="/images/trofeoG2.png";
                    break;
                case "3ra":
                    imagen.src="/images/trofeoG3.png";
                    break;

                case "4ta":
                    imagen.src="/images/trofeoG1.png";
                    break;
    ...
    <div id="menuCentral" style="background:url(/images/middleMenu.jpeg); background-size: cover; margin-left: -80px;" >
        ...
        <div class="myBox" style="background-image: url(/images/canchaF.png); background-size: cover; position: absolute; width: 780px; height: 600px; margin-left: 210px; top: 100px;-webkit-border-radius: 20px 20px;-webkit-border-radius: 20px 20px;">
            <div onmouseover="muestra('star');" onmouseout="ocultar('star');" class="cuadro2" style="margin-left: 30px; margin-top: 70px;">
                <div style="margin-top: -45px; margin-left: -25px;display: inline-block; background-size:45px 85px;background-repeat: no-repeat;"><img src="https://avatar.xboxlive.com/avatar/ealtamirano91/avatar-body.png"></div>
                ...
                <div style="width: 300px; margin-top: -105px; margin-left: 300px;">
                    ...
                    <br></br>
                    <span id="nomb"class="Info2">ealtamirano91</span>

                </div>
                <img id="star" src="/images/balonG.png" style="display: none;margin-top: 15px; margin-left: 430px; width: 80px;">
            ...
            <div onmouseover="muestra('star2');" onmouseout="ocultar('star2');" class="cuadro2" style="margin-left: 30px; margin-top: 70px;">
                <div style="margin-top: -45px; margin-left: -25px;display: inline-block; background-size:45px 85px;background-repeat: no-repeat;"><img src="https://avatar.xboxlive.com/avatar/ferace/avatar-body.png"></div>
                <div style="width: 30px; margin-top: -242px; margin-left: 130px;">
                    <span class="Info">TEMPORADA</span>
                    <br></br>
                    <span class="Info">DIVISION</span>
                ...
                <img id="star2" src="/images/balonG.png" style="display: none;margin-top: 15px; margin-left: 430px; width: 80px;">
            ...
            <div onmouseover="muestra('star3');" onmouseout="ocultar('star3');" class="cuadro2" style="margin-left: 30px; margin-top: 70px;">
                ...
                <div style="width: 300px; margin-top: -105px; margin-left: 300px;">
                    ...
                    <br></br>
                    <span id="nomb3"class="Info2">rotciv86</span>

                </div>
                <img id="star3" src="/images/balonG.png" style="display: none;margin-top: 15px; margin-left: 430px; width: 80px;">
            ...
            <div onmouseover="muestra('star4');" onmouseout="ocultar('star4');" class="cuadro2" style="margin-left: 30px; margin-top: 70px;">
                ...
                <img id="star4" src="/images/balonG.png" style="display: none;margin-top: 15px; margin-left: 430px; width: 80px;">
