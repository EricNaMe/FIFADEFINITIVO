...
@section('content')
    ...
    <div class="container">
        ...
        <form action="AgregarProTeamLiga" name="FormaAgregarClubaLiga" method="post" class="form-horizontal" role="form">
 ...
 <input type="hidden" name="_token" value="{{ csrf_token() }}">
  <input type="hidden" name="InputIdLeague" value="{{$league->id}}"/>
             ...
             <div style="position:relative; left:-40px;" class="form-group">
                ...
                <div class="col-sm-4">
                    <select id="clubSelect" onchange="seleccionaEquipo()" class="form-control" name="clubSelect"  type="text" value="">
                        <option value=""></option>
         ...
         <div style="position:relative; top:-50px; left:550px;" class="container">
             <button type="submit" class="btn btn-primary">Agregar</button>
                        ...
                        <input  type='text' id="textList2" name="textList2" value="" maxlength='30'/>                        
          
            
            
        
            
                   <form action="ProEliminarClubLiga" name="FormaAgregarClubaLiga2" method="post" class="form-horizontal" role="form">
